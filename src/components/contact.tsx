            ...
            <Card data-aos="zoom-in" className='h-[85vh] overflow-y-auto bg-slate-100'>
                ...
                <CardContent className="space-y-2">
                    <div className="container px-5 mx-auto flex sm:flex-nowrap flex-wrap">
                        ...
                        {/* map div */}
                        <div className="lg:w-2/3 md:w-1/2 bg-gray-100 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative -mt-4">
                            <iframe
                                width="100%"
                                height="100%"
                        ...
                        {/* main div 2*/}
                        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col -mt-4 md:ml-auto w-full md:py-8 md:mt-0">
